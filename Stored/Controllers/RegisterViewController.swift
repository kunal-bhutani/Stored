...
class RegisterViewController: UIViewController, UIImagePickerControllerDelegate, UINavigationControllerDelegate {
    ...
    private func configurePlaceholders() {
        let placeholderColor = UIColor(named: "Description Color")!
        
        [nameTextField, lastNameTextField, emailTextField, passwordTextField, confirmPasswordTextField].forEach { textField in
    ...
    @IBAction func didTapRegister() {
        ...
        DatabaseManager.shared.userExists(with: email) { [weak self] exist in
            ...
            guard !exist else {
                strongSelf.showAlert(title: "User Already Exists", message: "This user already exists.")
                return
            }
    ...
    private func validateFields() -> Bool {
        if nameTextField.text?.isEmpty == true {
            showAlert(title: "Missing Information", message: "Please enter your first name.")
            return false
        }
        ...
        if confirmPasswordTextField.text != passwordTextField.text {
            showAlert(title: "Password Mismatch", message: "The passwords you entered do not match.")
            return false
        }

        if imageView.image == nil || imageView.image?.isSymbolImage == true {
            showAlert(title: "Missing Profile Picture", message: "Please select a profile picture.")
            return false
        }
